...
# Calculates S:N by running mixed effects model predicting y and treating year and SITE_ID as random effects

#' snTest: Signal-to-noise Test
#'
#' @param dfIn
#' @param idVars.samp
#' @param idVars.site
#' @param year
#'
#' @return dataframe of variance between sites (SIGNAL) and variance within a site (NOISE)
#' @export
#'
#' @examples
